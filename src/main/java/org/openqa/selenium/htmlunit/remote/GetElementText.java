...
public class GetElementText implements HttpHandler {
    private final HtmlUnitDriverServer server;
    private final String sessionId;
    private final String elementId;

    public GetElementText(final HtmlUnitDriverServer server, final String sessionId, final String elementId) {
    ...
    public HttpResponse execute(final HttpRequest req) throws UncheckedIOException {
        return server.getElementText(sessionId, elementId);
    }
}
