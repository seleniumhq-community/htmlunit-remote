...
public class FindElements implements HttpHandler {
    private final HtmlUnitDriverServer server;
    private final String sessionId;

    public FindElements(final HtmlUnitDriverServer server, final String sessionId) {
    ...
    public HttpResponse execute(final HttpRequest req) throws UncheckedIOException {
        return server.findElements(req, sessionId);
    }
}
