...
public class GetCurrentUrl implements HttpHandler {
    private final HtmlUnitDriverServer server;
    private final String sessionId;

    public GetCurrentUrl(final HtmlUnitDriverServer server, final String sessionId) {
    ...
    public HttpResponse execute(final HttpRequest req) throws UncheckedIOException {
        return server.getCurrentUrl(sessionId);
    }
}
