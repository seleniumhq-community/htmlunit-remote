...
public class GetElementRect implements HttpHandler {
    private final HtmlUnitDriverServer server;
    private final String sessionId;
    private final String elementId;

    public GetElementRect(final HtmlUnitDriverServer server, final String sessionId, final String elementId) {
    ...
    public HttpResponse execute(final HttpRequest req) throws UncheckedIOException {
        return server.getElementRect(sessionId, elementId);
    }
}
