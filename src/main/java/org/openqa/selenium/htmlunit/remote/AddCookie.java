...
public class AddCookie implements HttpHandler {
    private final HtmlUnitDriverServer server;
    private final String sessionId;

    public AddCookie(final HtmlUnitDriverServer server, final String sessionId) {
    ...
    public HttpResponse execute(final HttpRequest req) throws UncheckedIOException {
        return server.addCookie(req, sessionId);
    }
}
