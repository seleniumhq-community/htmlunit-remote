...
public class GetNamedCookie implements HttpHandler {
    private final HtmlUnitDriverServer server;
    private final String sessionId;
    private final String cookieName;

    public GetNamedCookie(final HtmlUnitDriverServer server, final String sessionId, final String cookieName) {
    ...
    public HttpResponse execute(final HttpRequest req) throws UncheckedIOException {
        return server.getNamedCookie(sessionId, cookieName);
    }
}
