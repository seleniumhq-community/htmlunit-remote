...
public class NewSession implements HttpHandler {
    private HtmlUnitDriverServer server;
    
    public NewSession(final HtmlUnitDriverServer server) {
