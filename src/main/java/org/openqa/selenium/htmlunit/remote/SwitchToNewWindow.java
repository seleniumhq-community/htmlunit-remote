...
public class SwitchToNewWindow implements HttpHandler {
    private final HtmlUnitDriverServer server;
    private final String sessionId;

    public SwitchToNewWindow(final HtmlUnitDriverServer server, final String sessionId) {
    ...
    public HttpResponse execute(final HttpRequest req) throws UncheckedIOException {
        return server.switchToNewWindow(req, sessionId);
    }
}
