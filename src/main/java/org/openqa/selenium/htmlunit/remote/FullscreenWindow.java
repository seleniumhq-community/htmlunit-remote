...
public class FullscreenWindow implements HttpHandler {
    private final HtmlUnitDriverServer server;
    private final String sessionId;

    public FullscreenWindow(final HtmlUnitDriverServer server, final String sessionId) {
    ...
    public HttpResponse execute(final HttpRequest req) throws UncheckedIOException {
        return server.fullscreenWindow(sessionId);
    }
}
