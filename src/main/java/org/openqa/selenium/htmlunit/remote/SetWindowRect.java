...
public class SetWindowRect implements HttpHandler {
    private final HtmlUnitDriverServer server;
    private final String sessionId;

    public SetWindowRect(final HtmlUnitDriverServer server, final String sessionId) {
    ...
    public HttpResponse execute(final HttpRequest req) throws UncheckedIOException {
        return server.setWindowRect(req, sessionId);
    }
}
