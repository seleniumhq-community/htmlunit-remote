...
public class HtmlUnitDriverRemoteNavigationTest extends RemoteWebDriverTestCase {
    ...
    public void shouldBeAbleToNavigateToUrl() {
        ...
        HttpResponse response = server.navigateTo(request, sessionId);
    ...
    public void shouldBeAbleToGetCurrentUrl() {
        ...
        HttpResponse response = server.getCurrentUrl(sessionId);
    ...
    public void shouldBeAbleToNavigateBackAndForward() {
        ...
        HttpResponse response = server.navigateBack(sessionId);
        ...
        response = server.navigateForward(sessionId);
    ...
    public void shouldBeAbleToRefreshSession() {
        ...
        HttpResponse response = server.refreshSession(sessionId);
